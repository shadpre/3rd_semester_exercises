...
public class EasyLinqExercises : IEasyLinqExercises
{
    ...
    {
        var query = from i in numbers where i % 2 ==1  select i;
        return query.ToList();
    }
    ...
    {
        var query = from name in names select $"Hello, {name}";
        return query.ToList();
    }
    ...
    {
        var query = from number in numbers select number * 2;
        return query.ToList();
    }
    ...
    {
        var query = from word in words select word.ToUpper();
        return query.ToList();
    }
